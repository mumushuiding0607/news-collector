...
class AnimatedChangeText extends ConsumerStatefulWidget {
  final double change;
  ...
  @override
  ConsumerState<AnimatedChangeText> createState() => _AnimatedChangeTextState();
}

class _AnimatedChangeTextState extends ConsumerState<AnimatedChangeText>
  ...
  Color _getChangeColor(ThemeConfig theme, double change) {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final color = _getChangeColor(theme, _animation.value);
        return Text(
...
class ChangeIndicator extends ConsumerWidget {
  final double change;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = ref.watch(configProvider).theme;
    final color = _getChangeColor(theme, change);
